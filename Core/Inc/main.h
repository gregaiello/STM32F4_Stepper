...
#define POT_M1_Pin GPIO_PIN_1
#define POT_M1_GPIO_Port GPIOA
#define POT_M2_Pin GPIO_PIN_3
...
#define PUL_M1_Pin GPIO_PIN_9
#define PUL_M1_GPIO_Port GPIOE
#define PUL_M2_Pin GPIO_PIN_11
#define PUL_M2_GPIO_Port GPIOE
